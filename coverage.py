...
class Coverage():
    ...
    def __init__(self, model, criteria, k = 10, profiling_dict={}, exclude_layer=['input', 'flatten']):
        ...
        elif criteria == 'nc' or criteria == 'fann':
            self.k = k
        ...
        #print(type([inp] + [K.learning_phase()]))
    ...
    # def fnn_update_coverage(self, outputs, ptr):
    #     coverage_batch = outputs[0]
    #     coverage_list = []
    #     for idx in enumerate(coverage_batch.shape[0]):
